                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <form method="" action="<?php echo base_url() ?>addtype">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table id="datatable" class="table table-striped ">
                                                    ...
                                                    <td class="actions">
                                                        <a href="<?php base_url() ?>edittype/<?php echo $row['id']  ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                                        <a href="<?php echo base_url() ?>deletetype/<?php echo $row['id'] ?>" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                     </tr>
                                                     <?php $i++;
                                                     }
