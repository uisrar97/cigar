                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="m-b-30">
                                        <form method="" action="<?php echo base_url() ?>addpolicy">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-striped ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <a href="<?php base_url() ?>editpolicy/<?php echo $row['id']  ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?php echo base_url() ?>deletepolicy/<?php echo $row['id'] ?>" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php 
                                                    $i++;
