...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']."/admin",
	...
	|
	*/
	'upload_dir' => '/uploads/editor_images/',
	...
	|
	*/
	'current_path' => '../../../../uploads/editor_images/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../uploads/editor_images_thumbs/',
	...
	*/
	...
	'ext_video'                               => array('mp4','webm'), //Video
